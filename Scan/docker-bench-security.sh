...
# Load dependencies
source /home/ubuntu/docker-bench-security/functions/functions_lib.sh
source /home/ubuntu/docker-bench-security/functions/helper_lib.sh
...
source /home/ubuntu/docker-bench-security/functions/output_lib.sh
...
main () {
  ...
  source /home/ubuntu/docker-bench-security/tests/1_host_configuration.sh
  source /home/ubuntu/docker-bench-security/tests/2_docker_daemon_configuration.sh
  source /home/ubuntu/docker-bench-security/tests/3_docker_daemon_configuration_files.sh
  source /home/ubuntu/docker-bench-security/tests/4_container_images.sh
  source /home/ubuntu/docker-bench-security/tests/5_container_runtime.sh
  source /home/ubuntu/docker-bench-security/tests/6_docker_security_operations.sh
  source /home/ubuntu/docker-bench-security/tests/7_docker_swarm_configuration.sh
  source /home/ubuntu/docker-bench-security/tests/8_docker_enterprise_configuration.sh
  source /home/ubuntu/docker-bench-security/tests/99_community_checks.sh
